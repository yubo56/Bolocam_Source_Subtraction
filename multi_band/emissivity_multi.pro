function emissivity_multi, sig, specdens0, sigm, binwidth, init=init, real_amp=real_amp, real_x=real_x, real_y=real_y
compile_opt idl2, HIDDEN
; usual inputs
; computes emissivity by calling tnmin
; TODO: handling keywords like real_x, real_y is a pain...
...
if keyword_set(real_amp) then begin
    if keyword_set(real_x) then begin
        if keyword_set(real_y) then begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_amp=real_amp, real_x=real_x, real_y=real_y)
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_amp=real_amp, real_x=real_x)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endelse
    endif else begin
        if keyword_set(real_y) then begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_amp=real_amp, real_y=real_y)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endif else begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_amp=real_amp)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endelse
    endelse
endif else begin
    if keyword_set(real_x) then begin
        if keyword_set(real_y) then begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_x=real_x, real_y=real_y)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endif else begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_x=real_x)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endelse
    endif else begin
        if keyword_set(real_y) then begin
            ...
            ret = subtractmax_multi(sig, specdens0, sigm, binwidth, emissivity = emissivity, real_y=real_y)
            return, {xparam:ret.xparam, yparam:ret.yparam, Aest:ret.Aest, sig:ret.sig, sigm_x0:ret.sigm_x0, sigm_a:ret.sigm_a, chi2:ret.chi2, emissivity:emissivity, num_iters:num_iters, sigm_beta:ret.sigm_beta}
        endif else begin
